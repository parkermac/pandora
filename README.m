...
% makes a plot the user can choose to save it or not.
% If you chose a sequence of files then it automatically creates a
% directory and saves a sequence of numbered jpeg images there).
%
% ** zslice_preprocess.m **
...
% zslice_preprocess.m).
%
% other code is in pandora_user/plot_code.